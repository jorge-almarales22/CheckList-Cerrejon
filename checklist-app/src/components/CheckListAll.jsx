                ...
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/80 backdrop-blur-sm p-4 animate-[fadeIn_0.2s_ease-out]">
                    <div className={`${theme === 'dark' ? 'bg-slate-800 border-white/20 text-white' : 'bg-white border-slate-200 text-slate-900'} border p-6 md:p-8 rounded-3xl shadow-2xl max-w-5xl w-full`}>
                        <div className={`flex justify-between items-center mb-6 border-b pb-4 ${theme === 'dark' ? 'border-white/10' : 'border-slate-200'}`}>
                            ...
                            <button onClick={() => setShowTemplateModal(false)} className={`${theme === 'dark' ? 'text-white/50 hover:text-white' : 'text-slate-400 hover:text-slate-700'} text-2xl font-bold transition-colors`}>&times;</button>
                        </div>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
                            ...
                            >
                                ...
                                <p className={`text-sm mt-auto pt-4 border-t ${theme === 'dark' ? 'text-white/50 border-white/5' : 'text-slate-500 border-slate-200'}`}>Utiliza la plantilla con 49 items predefinidos.</p>
                            </div>
                            <div
                            ...
                            >
                                ...
                                <p className={`text-sm mt-auto pt-4 border-t ${theme === 'dark' ? 'text-white/50 border-white/5' : 'text-slate-500 border-slate-200'}`}>Utiliza la plantilla con 61 items predefinidos.</p>
                            </div>
                            <div
                            ...
                            >
                                ...
                                <p className={`text-sm mt-auto pt-4 border-t ${theme === 'dark' ? 'text-white/50 border-white/5' : 'text-slate-500 border-slate-200'}`}>Utiliza la plantilla con 67 items predefinidos.</p>
                            </div>
                        </div>
                    </div>
                </div>
