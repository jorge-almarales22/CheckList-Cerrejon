...
const GerenciaPieCharts = ({ checklists, theme }) => {
    ...
    return (
        <div style={fullBleed} className="mb-6 py-6 animate-[fadeIn_0.5s_ease-out] shadow-inner">
            <div className="max-w-[95%] mx-auto">
                <h1 className="text-2xl md:text-3xl font-black text-slate-900 mb-4 tracking-tight flex items-center gap-2">
                    <svg className="w-7 h-7 text-slate-900" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
